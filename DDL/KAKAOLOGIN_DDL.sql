select * from chogodzip.member;
show databases;
show tables;
-- drop schema bbs;
-- create schema chogodzip; // create schema bbs
-- use chogodzip; // use bbs
...
insert into member values(default, 'test1', '1212', '홍길동', 'test1@email.com', 'y', default,default, default);
insert into member values(default, 'test2', '1212', '박길동', 'test2@email.com', 'y', default,default, default);
insert into member values(default, 'admin', '1212', '이길동', 'amdin@email.com', 'y', default,default, default);
insert into member values(default, 'admin2', '1212', '최길동', 'admin@email.com', 'y', default,default, default);
commit;
